...
public class HomeFragment extends Fragment {
   ...
   private static final String URL = ApiConfig.BASE_URL + "/Pedidos_GA/App/Consultar.php";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Iniciar la actualización automatica al crear la vista
    ...
    private void obtenerPedidosV2() {
        ...
        // Agregar el nombre de usuario y v2=1 para incluir info de vehi­culo
        ...
        JsonArrayRequest jsonArrayRequest = new com.example.app_pedidos.network.Utf8JsonArrayRequest(
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        // Si la respuesta es vaci­a, mostrar estado sin datos
...
// Comparar el valor de sucursal y establecer la imagen
        ...
        // Aplicar el filtro de color segun el estado
        int filterColor;
        switch (estado) {
            case "ACTIVO":
...
// Agregar imageOrderTitle al layout
        ...
        textOrderDate.setText("Fecha Recepcion: " + pedido.getString("FECHA_RECEPCION_FACTURA"));
        ...
        btnVerDetalle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    // Verificar si todos los campos necesarios estan presentes en el JSON
     ...
     //   linearLayout.addView(textOrderTitle);
        ...
        // Agregar el boton al LinearLayout
